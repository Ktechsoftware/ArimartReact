      ...
      >
            ...
            <div className="p-2 lg:p-0">
              ...
              <div className="my-4">
                <AnimatePresence mode="wait">
                  ...
                  {activeTab === "more you like" && <ProductCard customGridClass={"grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-3 p-1"} />}
                </AnimatePresence>
              </div>
            </div>
          </div>
        ...
        <motion.div
          ...
          <div className="flex items-center gap-4 max-w-md mx-auto">
            <div className="flex items-center border rounded-full px-4 py-2 gap-3 bg-white/80 dark:bg-gray-800/80">
              <motion.button
                whileTap={{ scale: 0.8 }}
            ...
            >
              <motion.button
               ...
               rounded-full transition relative overflow-hidden"
              >
                <motion.span
                  animate={isCelebrating ? {
                    scale: [1, 1.5, 1],
                ...
                {isCelebrating ? "Added!" : "Add to cart"}

                {isCelebrating && <SprinkleHurray />}
              </motion.button>
            </motion.div>
          </div>
        </motion.div>
        {dotVisible && (
          <motion.div
            ...
            className="fixed w-6 h-6 bg-green-500 z-50 rounded-full pointer-events-none"
            style={{
              position: "fixed",
