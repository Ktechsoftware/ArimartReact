...
const AccountSettings = () => {
  ...
  return (
    ...
    >
      ...
      <img className="w-80 mx-auto rounded-xl" src="https://img.freepik.com/premium-vector/ecommerce-concept-illustration_690899-173.jpg" />
      {/* App Version */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        <span
          className="text-center font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#FF9933] via-white to-[#138808] animate-gradient-x"
        >
