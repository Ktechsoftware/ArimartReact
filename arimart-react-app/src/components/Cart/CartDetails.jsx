// src/components/cart/CartDetails.jsx - Updated for better integration
...
const {
  ...
  const regularCartItems = items;
const groupCartItems = groupItems;


  console.log("CartDetails items:", items);

  // Cart calculations
 const displaySubtotal = selectedTab === "group" ? groupSubtotal : subtotal;
const displayTotalItems = selectedTab === "group" ? groupTotalItems : totalItems;
...
const total = displaySubtotal + shipping - discount;
 ...
 useEffect(() => {
  if (selectedTab === "group" && currentGroupId) {
    fetchGroupCart(currentGroupId); // ✅ Correct function name
  }
}, [selectedTab, currentGroupId]);
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600 dark:text-gray-400">
                      Shipping {subtotal > 500 && '(Free over ₹500)'}
                    </span>
