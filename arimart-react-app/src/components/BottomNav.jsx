...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-4 mx-1 left-0 right-0 z-50">
 <div className="relative w-full max-w-lg px-1 mx-auto">
    <div className="absolute border dark:border-gray-500 inset-0 bg-white/60 dark:bg-gray-900/60 backdrop-blur-lg rounded-3xl shadow-xl" />
